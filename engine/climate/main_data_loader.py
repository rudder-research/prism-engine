...
# --- Configuration Paths ---
DATA_DIR = "/content/drive/MyDrive/prism_engine/climate_engine/./data/raw"
REGISTRY_PATH = "/content/drive/MyDrive/prism_engine/climate_engine/./data/registry/prism_metric_registry.json"
